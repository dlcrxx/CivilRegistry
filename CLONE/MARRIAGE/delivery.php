   ...
   <div class="birth-container">
        ...
        <form>
            ...
            <div class="submit-btn-birth">
                <button id="birth-back-btn" type="button" onclick="window.location.href='purpose.php'">Back</button>
            <button id="birth-btn" type="button" onclick="window.location.href='payment.php'">Continue</button>
            </div>
        </form>
    </div>
