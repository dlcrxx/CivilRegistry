...
<body>
    ...
    <div class="birth-container">
        ...
        <div class="form-title">
            <h6 style="margin-left: 10px;  margin-top: -6.5px; margin-bottom: -6.5px; font-size: small; ">Please enter the place where you were married.</h6>
        </div>
             <div class="form-group">
                <label class="input-label">Your Place of Marriage (Country)</label>
                <input class="input-value" type="text" id="marriage-place" placeholder="Country of Marriage">
             </div>
            <div class="form-group">
                <label class="input-label">Your Place of Marriage (Province)</label>
                <input class="input-value" type="text" id="birth-country" placeholder="Province of Marriage">
            </div>
            <div class="form-group">
                <label class="input-label">Your Place of Marriage (Municipality)</label>
                <input class="input-value" type="text" id="birth-province" placeholder="municipality of Marriage">
            </div>
              <div class="submit-btn-birth">
                <button id="birth-back-btn" type="button" onclick="window.location.href='wife.php'">Back</button>
