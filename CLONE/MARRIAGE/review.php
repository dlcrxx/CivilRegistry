...
<body>
    ...
    <div class="review-container">
        ...
        <div class="review-content">
            ...
            <div class="mother-info">
                <h3>
                    <?= ($_SESSION['sex'] === 'Male') ? 'Wife' : (($_SESSION['sex'] === 'Female') ? 'Husband' : 'Spouse') ?> Information
                </h3>
                <p><strong>First Name:</strong> <?= htmlspecialchars($_SESSION['spouse-first-name'] ?? '') ?></p>
                <p><strong>Middle Name:</strong> <?= htmlspecialchars($_SESSION['spouse-middle-name'] ?? '') ?></p>
                <p><strong>Last Name:</strong> <?= htmlspecialchars($_SESSION['spouse-last-name'] ?? '') ?></p>
            ...
            <div class="birth-place-info">
                ...
                <p><strong>Marriage Country:</strong> <?= htmlspecialchars($_SESSION['birth_country']) ?></p>
                <p><strong>Marriage Province:</strong> <?= htmlspecialchars($_SESSION['birth_province']) ?></p>
                <p><strong>Marriage Municipal:</strong> <?= htmlspecialchars($_SESSION['birth_municipal']) ?></p>
            </div>
            <div class="purpose">
    ...
    <script>
        ...
        const spouseFirst = <?= json_encode($_SESSION['spouse-first-name'] ?? '') ?>;
        const spouseMiddle = <?= json_encode($_SESSION['spouse-middle-name'] ?? '') ?>;
        const spouseLast = <?= json_encode($_SESSION['spouse-last-name'] ?? '') ?>;
        const marriageDate = <?= json_encode($_SESSION['dateOfMarriage'] ?? '') ?>;
