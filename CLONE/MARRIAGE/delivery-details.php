   ...
   <div class="birth-container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input class="input-value" type="email" id="email-address" placeholder="Email Address" name="email-address" autocomplete="off">
            </div>
