...
<body>
    ...
    <div class="birth-container">
        <div class="form-title">
         ...
         <form action="marriageplace.php" method="post">
            <div class="form-p">
                <p>Marriage Date</p>
            </div>
        <div class="form-title">
            <h6 style="margin-left: 10px;  margin-top: -6.5px; margin-bottom: -6.5px; font-size: small; ">Please enter the date when you got married.</h6>
        </div>
            <div class="form-group">
                <label class="input-label">Your Marriage Date</label>
                <input class="input-value" type="date" id="Marriage-Date" placeholder="Marriage Date">
            </div>
