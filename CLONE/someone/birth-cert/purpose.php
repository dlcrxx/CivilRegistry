...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $purpose = $_POST['their-selectPurpose'] ?? '';

    if ($purpose === 'Others') {
        $purpose = $_POST['their-other-reason'] ?? 'Others';
    }

    $_SESSION['their-selectPurpose'] = $purpose;
        ...
        <div class="form-title">
         ...
         <form method="post">
            ...
            <div class="form-group-purpose">
                ...
                <select class="input-value-purpose" id="selectPurpose" name="their-selectPurpose">
             ...
             <div class="form-group" id="otherReasonGroup" style="display: none;">
                ...
                <input class="input-value" type="text" id="other-reason" name="their-other-reason" placeholder="Input here" autocomplete="off">
            </div>
