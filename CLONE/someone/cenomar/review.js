...
document.getElementById('download-pdf-btn').onclick = function () {
    ...
    addSection("Someone's Information", [
        "Sex: " + theirSex,
        "First Name: " + theirFirstName,
        "Middle Name: " + theirMiddleName,
        "Last Name: " + theirLastName,
        ...(sex.toLowerCase() === "female" ? [
            "Marital Status: " + theirMartialStats,
            "Married Last Name: " + theirMarriedLastName
        ] : []),
        "Birthday: " + theirBirthday
    ]);
