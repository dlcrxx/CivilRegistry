   ...
   <div class="birth-container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input class="input-value" type="text" id="recipient-name" placeholder="Full Name" name="recipient-name" value="<?php echo htmlspecialchars($recipientName); ?>" autocomplete="off" readonly>
            </div>
            <div class="form-group">
