...
<body>
  <div class="dashboard-page">
      <aside class="sidebar">
        <a href="../employee/Cashier.php" title="Cashier"><i class="fa-solid fa-coins"></i></a>
        <a href="../admin/logout.php" title="Logout"><i class="fa-solid fa-right-from-bracket"></i></a>
    </aside>

    <main class="dashboard">
      <h2>Welcome, <?= isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Cashier'; ?>!</h2>
