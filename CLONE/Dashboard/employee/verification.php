...
<body>
    <div class="dashboard-page">
        <aside class="sidebar">
        <a href="../employee/verification.php" title="Verification"><i class="fa-solid fa-circle-check"></i></a>
        <a href="../admin/logout.php" title="Logout"><i class="fa-solid fa-right-from-bracket"></i></a>
    </aside>

        <main class="dashboard">
            <h2>Welcome,
                <?= isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Verification Officer'; ?>!
            </h2>
