...
<body>
  <div class="dashboard-page">
     <aside class="sidebar">
      <a href="../employee/signing.php" title="Document Signatory"><i class="fa-solid fa-file-signature"></i></a>
      <a href="../admin/logout.php" title="Logout"><i class="fa-solid fa-right-from-bracket"></i></a>
    </aside>

    <main class="dashboard">
      <h2>Welcome, <?= isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Document Signatory'; ?>!</h2>
    ...
    <div class="modal-content">
      ...
      <form id="editForm">
        ...
        <select id="statusSelect" name="status" required>
          ...
          <option value="Printed-Awaiting Signature">Printed-Awaiting Signature</option>
          <option value="Signed-Ready for Release">Signed-Ready for Release</option>
  ...
  </div><table class="calendar-table"><tr>
  ...
  for (let d = 1; d <= days; d++) {
    ...
    html += `<td><button type='button' class='date-btn' onclick="selectDate('${fullDate}')">${d}</button></td>`;
