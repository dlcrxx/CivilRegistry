...
<body>
  <div class="dashboard-page">
    ...
    <main class="dashboard">
      <h2>Welcome, <?= isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Employee'; ?>!</h2>
              ...
              <tr data-id="<?= htmlspecialchars($client['id']) ?>">
                ...
                <td>
                    ...
                    <button class="btn-delete" 
                      data-id="<?= htmlspecialchars($client['id']) ?>" 
                      style="font-size:15px; background: transparent; padding-left:5px; border: none; border-left: 1px solid rgb(0, 0, 20);">
                      Delete
                    </button>
                  </td>
              </tr>
